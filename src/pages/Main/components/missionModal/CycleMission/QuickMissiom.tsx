...
import { OpenQuickMission } from "../../../jotai.ts";
...
const QuickMission = () => {
  ...
  const [loadShelf, setLoadShelf] = useState<
    { label: string; value: string }[]
  >([]);
  const [offLoadShelf, setOffLoadShelf] = useState<
    { label: string; value: string }[]
  >([]);
    ...
    <>
      ...
      >
        <Form form={form}>
          ...
          <Form.Item
            label={t("car_control_translate.offload")}
            name={"offload"}
          >
            <Select
