...
const WarningTable: FC = () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: () => {
      return client.post("/api/records/delete-all-warning");
    },
    onSuccess: () => {
      refetch();
  ...
  const columns: ColumnsType<WarningRecord> = [
    ...
    },
    {
      ...
      render: (warningId: number, record) => (
        <WarningIdDesc>{record.warning.info_ch}</WarningIdDesc>
      ),
    },
    {
      title: "Timestamp",
        ...
        <StatusBar>
          <Flex gap={"middle"}>
            <Flex align="center" gap="middle">
              ...
              <span style={{ fontWeight: 600 }}>WARNING HISTORY</span>
            </Flex>
            <Flex gap="middle">
              <Popconfirm
