              ...
              <>
                ...
                <Box>
                  ...
                  <InfoWrapper>
                    ...
                    <C b={info.error.BATTERY_NOT_CONNECTED}>
                      {t("charge.batteryNotConnected")}
                    </C>
                    <C b={info.error.SHORT_CIRCUIT}>
