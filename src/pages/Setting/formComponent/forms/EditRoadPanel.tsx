...
const EditRoadPanel: React.FC<{
  ...
  const saveRoad = () => {
    const payload: Road = {
      ...
      validYawList: roadPanelForm.getFieldValue("validYawList") as
        | number[]
        | string[],
    ...
    <>
      ...
      <div style={{ width: "23em" }}>
        ...
        >
          ...
          >
            <Form.Item
              label={t("edit_road_panel.start_point")}
              name="x"
              shouldUpdate
              required
            >
            ...
            <Form.Item
              label={t("edit_road_panel.end_point")}
              name="to"
              shouldUpdate
              required
            >
